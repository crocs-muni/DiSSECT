...
curve_brain = CustomCurve(
    {
        ...
        "form": "Weierstrass",
        "params": {
            "a": {"raw": "0x340e7be2a280eb74e2be61bada745d97e8f7c300"},
            "b": {"raw": "0x1e589a8595423412134faa2dbdec95c8d8675e58"},
        },
        "generator": {
            "x": {"raw": "0xbed5af16ea3f6a4f62938c4631eb5af7bdbcdbc3"},
            "y": {"raw": "0x1667cb477a1a8ec338f94741669c976316da6321"},
        },
        ...
        "characteristics": {
            ...
            "torsion_degrees": [
                {"r": 2, "least": 3, "full": 3},
                {"r": 3, "least": 2, "full": 6},
                {"r": 5, "least": 12, "full": 12},
                {"r": 7, "least": 8, "full": 8},
                {"r": 11, "least": 5, "full": 55},
            ],
        },
    }
)
...
curve_bn = CustomCurve(
    {
        ...
        "form": "Weierstrass",
        "params": {
            "a": {"raw": "0x0000000000000000000000000000000000000000"},
            "b": {"raw": "0x0000000000000000000000000000000000000011"},
        },
        "generator": {
            "x": {"raw": "0x24240D8241D5445106C8442084001384E0000012"},
            "y": {"raw": "0x0000000000000000000000000000000000000004"},
        },
...
curve_sec = CustomCurve(
    {
        ...
        "oid": "1.3.132.0.7",
        "field": {"type": "Prime", "p": "0xdb7c2abf62e35e668076bead208b", "bits": 112},
        "form": "Weierstrass",
        "params": {
            "a": {"raw": "0x6127c24c05f38a0aaaf65c0ef02c"},
            "b": {"raw": "0x51def1815db5ed74fcc34c85d709"},
        },
        "generator": {
            "x": {"raw": "0x4ba30ab5e892b4e1649dd0928643"},
