...
def main():
    ...
    parser.add_argument(
        "-s", "--script", dest="script", help="Sage script file to load"
    )
    parser.add_argument(
        "-a",
        "--action",
    ...
    parser.add_argument(
        "-f", "--function", dest="function", help="Function name to call"
    )
    parser.add_argument(
        "-j", "--json", dest="json", help="JSON input to pass to the function"
    )
    parser.add_argument(
        "-c", "--cli", dest="cli", help="Command line arguments to pass to the script"
    )
