...
results = {
    'secp112r2': {
        '{}': {
            'distance': 740611633441112928659565470072532,
            'ratio': 6.01082,
            'distance 32': 12,
            'distance 64': 20}},
    'bn158': {
        '{}': {
            'distance': 23639966694374437715554742421545236103616790541,
            'ratio': 8.72792,
            'distance 32': 13,
            'distance 64': 13}},
    'brainpoolP160r1': {
        '{}': {
            'distance': 129204038890858043376599793886101655442989974519,
            'ratio': 10.31158,
            'distance 32': 9,
            'distance 64': 9}}}
...
class TestI07(unittest.TestCase):
    ...
    def test_auto_generated_brainpoolP160r1(self):
        ...
        computed_result = i07_curve_function(
