...
results = {'secp112r2': {
    "{'deg': 2}": {'ratio_sqrt': 72213667414400864, 'factorization': [2, 2, 2, 2, 2, 11, 205152464245457]}}, 'bn158': {
    "{'deg': 2}": {'ratio_sqrt': 454233058419889982668807, 'factorization': [2953, 153820879925462235919]}},
    'brainpoolP160r1': {"{'deg': 2}": {'ratio_sqrt': 519972310379544251229703,
                                       'factorization': [3023, 49277, 3490581720239293]}}}
