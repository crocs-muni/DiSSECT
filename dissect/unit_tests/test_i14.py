import unittest
import ast
from dissect.traits.i14.i14 import i14_curve_function
from dissect.traits.example_curves import curve_names
results = {
    'secp112r2': {
        '{}': None}, 'bn158': {
            '{}': None}, 'brainpoolP160r1': {
                '{}': None}}


class TestI14(unittest.TestCase):
    ...
    def test_auto_generated_secp112r2(self):
        ...
        computed_result = i14_curve_function(curve_names["secp112r2"], *params)
        self.assertEqual(
            list(
    ...
    def test_auto_generated_bn158(self):
        ...
        computed_result = i14_curve_function(curve_names["bn158"], *params)
    ...
    def test_auto_generated_brainpoolP160r1(self):
        ...
        computed_result = i14_curve_function(
