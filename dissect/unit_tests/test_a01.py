...
results = {
    'secp112r2': {
        "{'deg': 1}": {
            'ord1': 1,
            'ord2': 4451685225093714699870930859147564}},
    'bn158': {
        "{'deg': 1}": {
            'ord1': 1,
            'ord2': 206327671360737302491015346511080613560608358413}},
    'brainpoolP160r1': {
        "{'deg': 1}": {
            'ord1': 1,
            'ord2': 1332297598440044874827085038830181364212942568457}}}
...
class TestA01(unittest.TestCase):
    ...
    def test_auto_generated_brainpoolP160r1(self):
        ...
        computed_result = a01_curve_function(
