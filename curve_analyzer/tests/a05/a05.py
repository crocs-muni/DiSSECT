...
def compute_a05_results(curve_list, l_max=20, order_bound=256, desc=''):
    global_params = {'l_range': prime_range(l_max)}
    params_local_names = ['l']
    compute_results(curve_list, 'a05', a05_curve_function, global_params, params_local_names, order_bound, desc=desc)
