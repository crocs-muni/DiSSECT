...
def generate_x962_curves(count, p, curve_seed, seed_offset=0, increment_step=1, verify=True,
                         r_min_bits=160, save_to_json=True, jsonfile="curves_json/x962-sim/curves.json",
                         logfile="curves_json/x962-sim/curves.log", overwrite=False, verbosity_freq=1000,
                         l_max=20):
    a = -3
    #
    ...
    bits = p.nbits()
    # feedback("Generating " + str(bits) + "-bit curves from the initial seed " + str(seed) + " offset by " + str(
    #     seed_offset) + "...\n")
    sim_curves = {}
    sim_curves["name"] = "x962_sim_" + str(bits)
    sim_curves["desc"] = "simulated curves generated according to the X9.62 standard using the initial seed " + str(
        seed) + " (the standard seed offset by " + str(seed_offset) + ")"
    ...
    for i in range(1, count + 1):
        ...
        # if i % verbosity_freq == 0:
            ...
            # feedback(str(i) + " out of " + str(count) + " curves tried, currently at seed " + str(
            #     int_to_hex_string(rel_seed)) + ", time elapsed: " + str(diff_time) + "\n")
            # start_time = time.time()
...
#
# def generate_x962_standard_like_curves(bitlen, count, offset=0, save_to_json=True, overwrite=False, verbosity_freq=1000,
#                                        l_max=20):
...
#     x962_params.append(
#         (192, 0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFFFFFFFFFF, '3045AE6FC8422F64ED579528D38120EAE12196D5'))
#     x962_params.append(
#         (224, 0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF000000000000000000000001, 'BD71344799D5C7FCDC45B59FA3B9AB8F6A948BC5'))
#     x962_params.append((256, 0xFFFFFFFF00000001000000000000000000000000FFFFFFFFFFFFFFFFFFFFFFFF,
#                         'C49D360886E704936A6678E1139D26B7819F7E90'))
#     x962_params.append((384,
#                         0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFF0000000000000000FFFFFFFF,
#                         'A335926AA319A27A1D00896A6773A4827ACDAC73'))
#     x962_params.append((521,
