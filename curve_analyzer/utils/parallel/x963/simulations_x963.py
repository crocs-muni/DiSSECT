...
def generate_x963_curves(count, p, seed):
    bits = p.nbits()
    sim_curves = {"name": "x963_sim_" + str(bits), "desc": "simulated curves generated according to the X9.62 standard",
    ...
    with open('x963/parameters_x963.json', 'r') as f:
        params = json.load(f)
    ...
    for i in range(1, count + 1):
        ...
        sim_curve = {
            "name": "x963_sim_" + str(bits) + "_seed_diff_" + str(seed_diff),
