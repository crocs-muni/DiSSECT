...
def curve_gen(curve_db, curve_type, order_bound, verbose, binary, extension, single_curve, allow_cofactor):
    sources = curve_db.keys()
    for source in sources:
        curves = curve_db[source]['curves']
        for curve in curves:
            if not allow_cofactor and curve["cofactor"]:
                continue
...
def custom_curves(curve_db, curve_type, order_bound, verbose, binary, extension, single_curve, allow_cofactor):
    return [c for c in
            curve_gen(curve_db, curve_type, order_bound, verbose, binary, extension, single_curve, allow_cofactor)]
